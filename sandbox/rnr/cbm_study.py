...
# --- CONFIGURATION ---
FILE_REPEATABILITY = r"raw/cbm_repeatability.csv"
FILE_REPRODUCIBILITY = r"raw/cbm_reproducibility.csv"
OUTPUT_DIR = "results"
...
def main():
    ...
    if os.path.exists(FILE_REPEATABILITY):
        ...
        exclude_cols = ['Sample', 'Day', 'Run', 'Scan', 'Site',
    ...
    if rep_results:
        export_results(rep_results, os.path.join(OUTPUT_DIR, "CBM_Repeatability_Results.csv"))
    ...
    if os.path.exists(FILE_REPRODUCIBILITY):
        ...
        exclude_cols = ['Sample', 'Machine', 'Day', 'Scan', 'Site',
                        'Creation_Date', 'Total WBC', 'Total RBC',
                        'Platelet Clumps', 'Platelet Satellitism',
                        'Unclassified WBC', 'Poikilocytes', 'Blister',
                        'Bite', 'Burr', 'Spur', 'Ovalo', 'Ellipto', 'Scan UUID']
        ...
        if repro_results:
            export_results(repro_results, os.path.join(OUTPUT_DIR, "CBM_Reproducibility_Results.csv"))
