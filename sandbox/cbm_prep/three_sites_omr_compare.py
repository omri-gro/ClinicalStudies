...
if __name__ == "__main__":
    ...
    sptr_cbm_csv = False
    cases_to_filter = r'flt_lists/slides_to_remove.csv'
    ...
    if sptr_cbm_csv:
        ...
        # cbm numbers are already in single file
    ...
    methd_comp.save_results(rf'results/omr/{save_name}_reg.csv')
    methd_comp.save_results(rf'results/omr/{save_name}_bias.xlsx', result_type='bias')
    methd_comp.plot_all_regressions(f'results/omr/{save_name}_reg.pdf')
